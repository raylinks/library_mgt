                                ...
                                <form @submit.prevent="submit()" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="author" v-model="addAuthor.author" placeholder="enter author" class="form-control input-height"> </div>
                                        </div>
...
<script>
    import {postAuthor} from '../Utilities/Config'
    export default{
        data(){
            return{
                addAuthor:{
        ...
        methods: {
            submit() {
                axios.post(postAuthor, this.addAuthor).then(response => {
                    this.submitted = true;
                    this.addAuthor="";
