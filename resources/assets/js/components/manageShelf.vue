                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-box">
                            <div class="card-head">
                                <header>Book Shelves Listing</header>
                                <!--<div class="tools">
                                ...
                                <div class="table-scrollable">
                                    <div  class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                        ...
                                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-sort="ascending" aria-label=": activate to sort column descending" style="width: 40px;"></th>
                                            <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label=" Name : activate to sort column ascending" style="width: 65px;"> Shelf Name</th>
                                            <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label=" Department : activate to sort column ascending" style="width: 88px;">Total Books </th>
                                            <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label=" Gender : activate to sort column ascending" style="width: 53px;">Status </th>
                                            <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label=" Gender : activate to sort column ascending" style="width: 53px;">Creation Date</th>
                                        ...
                                        <tr v-for="cat in filteredData" class="gradeX odd" role="row">
                                            ...
                                            <td>
                                                <a href="" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal5" title="Edit">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a :href="`/delete-shelf/${cat.id}`"  class="btn btn-danger btn-xs" title="Delete">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                        ...
                                        <span v-if="bookshelves && bookshelves.length == 0 ">
            <h2 class="success" style="color:tomato">No ShelfBook Available...</h2>
        </span>
                                    </div>
                                    </div>
                                        <div class="row">
                                                    ...
                                                    <ul class="pagination">
                                                        <li v-bind:class="[{disabled: !pagination.prev_page_url}]" class="page-item" >
                                                            <a class="page-link" href="#"
                                                               @click=" getBookShelves(pagination.prev_page_url)" >Previous</a>
                                                        </li>
                                                        ...
                                                        <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><a class="page-link" href="#" @click=" getBookShelves(pagination.next_page_url)">Next</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
<script>
    import {getShelves} from '../Utilities/Config'
    export default{
        data(){
            return{
                shelve:{
        ...
        methods:{
            /*getBookShelves(){
                axios.get(getShelves).then((res) => {
                    this.bookshelves = res.data
                })

            },*/
            getBookShelves(page_url) {
                // let vm=this;
                page_url = page_url || getShelves
