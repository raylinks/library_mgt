                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="card card-box">
                            ...
                            <div class="alert alert-success" v-if="submitted">
                                ...
                                BookShelf is Successfully added
                            </div>
                                ...
                                <form @submit.prevent="submit()" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="bookshelf" v-model="addShelves.bookshelf" placeholder="enter category" class="form-control input-height"> </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control input-height" v-model="addShelves.status" name="status">
...
<script>
    import {postBookshelf} from '../Utilities/Config'
    export default{
        data(){
            return{
                addShelves:{
        ...
        methods: {
            submit() {
                axios.post(postBookshelf, this.addShelves).then(response => {
                    this.submitted = true;
                    this.addShelves="";
