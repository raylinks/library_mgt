                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="card card-box">
                            ...
                            <div class="card-body" id="bar-parent">
                                <form @submit.prevent="postIssuedBook()" class="form-horizontal">
                                    <input type="hidden"  name="id" v-model="loggedInUser.id">
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="student_id" v-model="issued.student_id" placeholder="enter student id" class="form-control input-height"> </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="isbn" v-model="issued.isbn" placeholder="enter isbn" class="form-control input-height"> </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="control-label col-md-3">BookName
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-5">
                                                <select class="form-control input-height" v-model="issued.book" name="category_id">
                                                    <option value="">Select BookName</option>
                                                    <option v-for="one in book"  v-bind:value="one.id">{{ one.name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input name="return_d" type="date" v-model="issued.return_d" placeholder="date" class="form-control input-height"> </div>
                                        </div>
...
<script>
    ...
    import {getBooks} from '../Utilities/Config'

    import {postIssued} from '../Utilities/Config'
    export default{
        data(){
            return{
                issued:{
        ...
        methods:{
            postIssuedBook(){
                ...
                axios.post( `${Laravel.appUrl}/library/issued/books`,this.issued).then(response=>{
                    this.submitted = true;
                    this.issued="";
